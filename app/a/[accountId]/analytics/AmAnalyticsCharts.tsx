...
export default function AmAnalyticsCharts({ taskTrend, statusDist, categoryPerf, commFreq, projectHealth, amName }: Props) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
      ...
      {/* Row 2: Per-project health + Category performance */}
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
        ...
        <div className="panel" style={{ padding: '20px' }}>
          <h3 style={{ margin: '0 0 4px', fontSize: '14px', fontWeight: 700 }}>Category Performance</h3>
          <p style={kpiTextStyle}>Tasks closed and reworks by category</p>
          <ResponsiveContainer width="100%" height={220}>
